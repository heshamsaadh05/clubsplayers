...
const AdminEditPlayerForm = ({ player, isOpen, onClose, onUpdate }: AdminEditPlayerFormProps) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>تعديل بيانات اللاعب (المدير)</DialogTitle>
        </DialogHeader>
        ...
        >
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              placeholder="افصل بين الأندية بفاصلة"
            />
          </div>

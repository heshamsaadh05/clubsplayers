...
const AdminSidebar = ({ isOpen: externalIsOpen, onClose }: AdminSidebarProps) => {
  ...
  const menuItems = [
    ...
    { icon: Heart, labelKey: 'admin.playerInterests', path: '/admin/interests', keywords: ['interests', 'اهتمام', 'عرض', 'طلب'] },
    { icon: Video, labelKey: 'admin.consultations', path: '/admin/consultations', keywords: ['consultations', 'استشارة', 'حجز', 'meet'] },
    { icon: Video, labelKey: 'admin.meetLogs', path: '/admin/meet-logs', keywords: ['meet', 'logs', 'سجل', 'اجتماعات', 'google'] },
